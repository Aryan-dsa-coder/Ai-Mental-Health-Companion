#Step1: Setup Ollama with bsahane/gemma3:1b tool
import ollama
...
def call_emergency():
    print("📞 Attempting emergency call...")

    client = Client(TWILIO_ACCOUNT_SID, TWILIO_AUTH_TOKEN)

    call = client.calls.create(
        to=EMERGENCY_CONTACT,           # MUST be verified
        from_=TWILIO_FROM_NUMBER,       # MUST be Twilio number
